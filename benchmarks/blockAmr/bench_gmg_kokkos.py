...
a whole solver phase: the V-cycle of ``linearAlgebra/gmg/gmgPrecond.hpp``, run with its AMReX
...
# The production V-cycle shape (gmgPrecond.hpp defaults): 2 pre + 2 post RB-SOR
