...
public:
    ...
    void implicitOperation(la::LinearSystem<ValueType>& ls) { model_->implicitOperation(ls); }
...
private:
    ...
    struct OperatorConcept
    {
        ...
        virtual void implicitOperation(la::LinearSystem<ValueType>& ls) = 0;
    ...
    struct OperatorModel : OperatorConcept
    {
        ...
        virtual void implicitOperation(la::LinearSystem<ValueType>& ls) override
        {
