...
void registerBox(nb::module_& m)
{
    ...
    nb::class_<Box>(m, "Box")
        ...
        .def(
            nb::init<const IntVect&, const IntVect&, IndexType>(),
            nb::arg("small"),
            nb::arg("big"),
            nb::arg("t")
        )
        .def(
            "__init__",
            [](Box* self, const std::array<int, 3>& lo, const std::array<int, 3>& hi, IndexType t)
    ...
    nb::class_<RealBox>(m, "RealBox")
        .def(
            "__init__",
            [](RealBox* self, const std::array<double, 3>& lo, const std::array<double, 3>& hi)
