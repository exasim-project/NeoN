...
"""Create a uniform 2D mesh (OpenFOAM-style hex slab) and write to VTU, CGNS, and VTK HDF."""
...
neon.write_vtu(mesh, "grid2d.vtu")
neon.write_cgns(mesh, "grid2d.cgns")
neon.write_vtk_hdf(mesh, "grid2d.vtkhdf")

print("Written: grid2d.vtu, grid2d.cgns, grid2d.vtkhdf")

grid = pv.read("grid2d.vtu")
